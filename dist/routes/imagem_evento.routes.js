...
const imagem_evento_controller_1 = require("../controllers/imagem_evento.controller");
...
router.post("/", upload.single("imagem"), (req, res) => {
    (0, imagem_evento_controller_1.criarImagemEvento)(req, res);
});
/**
 * @swagger
...
router.post("/multiplas", upload.array("imagens", 10), (req, res) => {
    (0, imagem_evento_controller_1.criarMultiplasImagensEvento)(req, res);
});
...
router.put("/:id", (req, res) => {
    (0, imagem_evento_controller_1.atualizarImagemEvento)(req, res);
});
/**
 * @swagger
 * /evento-imagem:
 ...
 */
router.get("/", (req, res) => {
    (0, imagem_evento_controller_1.listarImagemEventos)(req, res);
});
